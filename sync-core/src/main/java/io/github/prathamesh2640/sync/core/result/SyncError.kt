...
public sealed class SyncError {
     ...
     * resolved (for example, the host app's [io.github.prathamesh2640.sync.core.adapter.ConflictResolver]
     * threw or declined to pick a winner). The entity is left in the
     * [io.github.prathamesh2640.sync.core.model.SyncState.CONFLICT] state for manual handling.
     *
     * @property entityId the [io.github.prathamesh2640.sync.core.model.SyncableEntity.id]
